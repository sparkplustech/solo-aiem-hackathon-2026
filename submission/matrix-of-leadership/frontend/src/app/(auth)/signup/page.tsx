      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[var(--bg-card)]/50 p-12 flex-col justify-between border-r border-[var(--border-color)]">
        <div>
          ...
          <h2 className="text-4xl font-bold text-[var(--text-main)] leading-tight mb-6">
            Join the network. <br/>Stop the fraud.
          </h2>
          <p className="text-lg text-[var(--accent-light)]/80 max-w-md leading-relaxed">
            Get early access to the most advanced AI-driven transaction monitoring platform tailored for UPI systems.
          </p>
        </div>
        
        <div className="glass-card p-6 border-l-4 border-[var(--accent-copper)]">
          <p className="text-sm italic text-[var(--accent-light)] mb-4">
            "We integrated DRISHTI into our risk stack in under a week. The immediate visibility into multi-hop mule networks was game-changing."
          </p>
          <div className="flex items-center">
            <div className="w-10 h-10 rounded-full bg-[var(--bg-primary)] border border-[var(--border-color)] flex items-center justify-center mr-3">
              <span className="text-xs font-bold text-[var(--accent-copper)]">VP</span>
            </div>
            <div>
              <p className="text-sm font-bold text-[var(--text-main)]">Global Payment Gateway</p>
              <p className="text-xs text-[var(--accent-light)]">Early Adopter</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 p-8 lg:p-16 flex flex-col justify-center bg-[var(--bg-primary)]/80">
        <div className="max-w-md w-full mx-auto">
          ...
          <div className="space-y-4" onKeyDown={(e) => e.key === 'Enter' && handleSignup(e as any)}>
            ...
            <div>
              <label className="block text-xs font-bold text-[var(--accent-light)] tracking-wide mb-1.5">WORK EMAIL</label>
              <input 
                type="email" 
                name="email"
            ...
            <div>
              <label className="block text-xs font-bold text-[var(--accent-light)] tracking-wide mb-1.5">COMPANY</label>
              <input 
                type="text" 
                name="company"
            ...
            <div>
              <label className="block text-xs font-bold text-[var(--accent-light)] tracking-wide mb-1.5">PASSWORD</label>
              <input 
                type="password" 
                name="password"
